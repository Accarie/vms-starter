    ...
    >
      ...
      <div>
        ...
        <Input
          ...
          type="email"
          {...register("email")}
          className="border-black focus:ring-orange-500  py-6"
        />
        {errors.email && (
      ...
      <div>
        ...
        />
        {errors.names && (
          <p className="text-orange-600 text-sm mt-1">{errors.names.message}</p>
        )}
      </div>
      ...
      <Button
        ...
        className="w-full bg-gray-700 hover:bg-gray-800 py-6 focus:ring-orange-500"
      >
