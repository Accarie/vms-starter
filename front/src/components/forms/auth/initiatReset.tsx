  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md mx-auto p-6  rounded space-y-6 bg-white text-black">
      ...
      <div>
        ...
        <Input id="email" type="email" {...register('email', { required: 'Email is required' })} className="border-black focus:ring-orange-500" />
        {errors.email && <p className="text-orange-600 text-sm mt-1">{errors.email.message}</p>}
      </div>
      <Button type="submit" disabled={isSubmitting} className="w-full bg-orange-700 hover:bg-orange-800 focus:ring-orange-500">
